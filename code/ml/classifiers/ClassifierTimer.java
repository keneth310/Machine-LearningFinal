...
public class ClassifierTimer {
	...
	public static void main(String[] args){
		DataSet dataset = new DataSet("data/wines.train", DataSet.TEXTFILE);
		int numRuns = 10;

		System.out.println("------------------------");
		System.out.println("OVA:");
		ClassifierFactory cl = new ClassifierFactory(0,2);
		OVAClassifier OVAClassi = new OVAClassifier(cl);
		timeClassifier(OVAClassi, dataset, numRuns);


		System.out.println("------------------------");
		System.out.println("AVA:");
		ClassifierFactory cl2 = new ClassifierFactory(0,2);
		AVAClassifier AVAClassi = new AVAClassifier(cl2);
		timeClassifier(AVAClassi, dataset, numRuns);
	}
}
